...
class Process
{
    ...
    public function get_process_list()
    {
        ...
        $list[53] = array(_("Last Feed value"),ProcessArg::FEEDID,"last_feed_value",1,DataType::REALTIME,"Misc",array(Engine::PHPFIWA,Engine::PHPFINA,Engine::PHPTIMESERIES));               
        $list[54] = array(_("Accumulator Daily"),ProcessArg::FEEDID,"accumulator_daily",1,DataType::DAILY,"Misc",array(Engine::PHPTIMESERIES));               
